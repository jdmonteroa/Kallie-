...
**Abū Yūsuf Yaʿqūb ibn Isḥāq al-Kindī** (801–873 d.C.) fue el primer criptógrafo en describir el **análisis de frecuencias**, 
técnica que permite romper cualquier cifrado de sustitución simple contando la frecuencia de aparición de cada carácter y 
comparándola con la distribución estadística conocida del idioma.

Su obra *Risālah fī Istikhrāj al-Kutub al-Muʿammāh* demostró que César y Atbash son vulnerables porque preservan la 
distribución estadística del idioma original. Por esta razón tienen hoy valor exclusivamente educativo.
...
- https://www.reddit.com/r/learnpython/comments/16y4chs/caesar_cipher_basic/?tl=es-es
...
Desarrollado por Jesus David Montero Ayala como proyecto académico para la materia de **Seguridad Informática**.
